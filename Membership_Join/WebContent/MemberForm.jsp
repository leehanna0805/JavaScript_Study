...
<script src="./js/juminCheck.js" charset="UTF-8"></script>		<!-- 이렇게 연동해야함.  한글 안깨지도록 UTF-8로주자 -->
<script src="./js/idCheck.js" charset="UTF-8"></script>
<script src="./js/change_email.js" charset="UTF-8"></script>
...
<style>
	...
	tbody.tbody>tr>td:nth-child(1) { width:16%; vertical-align:middle; 		<!-- 첫번째 열 -->
				...
				<table border="2">
					...
					<tbody class="tbody">
						...
						<tr>
							...
							<td>
								<input type="password" name="mem_repasswd" maxlength="12" minlength="8" required/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="mem_email_domain" id="email_add"/>	<!-- id값으로 js파일과 상호작용 -->
						...
						<tr>
							<td>성별</td>
							<td>
								<input type="radio" name="mem_gender" value="M" checked/>남성&nbsp;&nbsp;&nbsp;
								<input type="radio" name="mem_gender" value="F"/>여성
							</td>
						</tr>
						<tr>
							...
							<td>
							<script>
								var today = new Date(); //현재시간 가져옴
								var toyear = parseInt(today.getFullYear()); //2021년 얻어옴
								var start = toyear-15; //만 14세 이상 가입 가능
								var end = toyear-80;   //80세 이상분들은 잘 안쓸것으로 예상
						...
						<tr>
							...
							<td>
								...
								<p>
									...
									<input type="text" name="userAddr3" id="extraAddress" size="48" placeholder="참고항목(도로명인 경우: 지역이름과 아파트이름)"/>
									<input type="text" name="userAddr2" id="detailAddress" size="45" placeholder="상세주소(아파트 동호수 또는 빌딩이름 입력요!)"/>
								</p>
